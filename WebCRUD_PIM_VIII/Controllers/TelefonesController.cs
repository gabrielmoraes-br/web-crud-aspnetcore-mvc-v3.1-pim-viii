...
namespace WebCRUD_PIM_VIII.Controllers
{
    public class TelefonesController : Controller
    {
        ...
        public TelefonesController(WebCRUDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,DDD")] Telefone telefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,DDD")] Telefone telefone)
        {
            if (id != telefone.Id)
            {
                return NotFound();
